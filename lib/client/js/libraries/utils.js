 ...
 */
var GENERATE_RAND_KEY = function GENERATE_RAND_KEY() {
  var randKey = '';
  for (var a = 0; a < 4; ++a) {
 ...
 */
var PARSE_TIMESTAMP = function PARSE_TIMESTAMP(timestamp) {
 ...
 */
var PARSE_BYTES = function PARSE_BYTES(bytes, si) {
...
var NORMILIZE_RESPONSE = function NORMILIZE_RESPONSE(response) {
 ...
 */
var HEX_DUMP = function HEX_DUMP(blob, fromByte) {
 ...
 */
var CAMEL_CASE_IT = function CAMEL_CASE_IT(string) {
...
var SNAKE_CASE_IT = function SNAKE_CASE_IT(str) {
...
var LOGGED_OUT_ADDR = function LOGGED_OUT_ADDR() {
...
var NOT_LOGGED_ADDR = function NOT_LOGGED_ADDR() {
